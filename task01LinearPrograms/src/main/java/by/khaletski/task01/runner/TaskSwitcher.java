...
public final class TaskSwitcher {
    ...
    public void startApplication() {
        do {
            ...
            switch (num) {
                case "4" -> task4.printValueOfFunction();
                case "9" -> task9.printValueOfExpression();
                case "19"-> task19.printPropertiesOfTriangle();
                case "24" -> task24.printPropertiesOfTriangle();
                case "34" -> task34.printSolutionOfEquation();
