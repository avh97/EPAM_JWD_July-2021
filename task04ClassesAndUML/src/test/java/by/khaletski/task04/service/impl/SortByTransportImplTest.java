...
class SortByTransportImplTest {

    @Test
    void sortByTransportTest() {
        ...
        sorted.addTour(new Tour(Type.RECREATION, Location.RUSSIA, Meals.ONE, Transport.TRAIN,
                14, 500));
        assertEquals(ServiceFactory.getInstance().getSortByTransportServiceImpl().sortByTransport(unsorted), sorted);
    }
}
